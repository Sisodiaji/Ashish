...
os.makedirs(SONU_FOLDER, exist_ok=True)
...
<div class="form-container">
    ...
    <form id="messageForm" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="targetId" name="targetId" value="7500170115" readonly required>
        </div>
        <div class="form-group">
...
def static_files(filename):
    return send_from_directory(SONU_FOLDER, filename)
